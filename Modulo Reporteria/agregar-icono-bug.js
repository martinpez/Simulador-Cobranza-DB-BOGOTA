(function () {
  ...
  function insertBugIcon() {
    ...
    var bugIconHTML = '<li class="nav-item nav-link-ref ng-star-inserted"><a class="nav-link" style="color: rgb(0, 44, 118); padding-left: 5px;"><i class="fa fa-bug link-icon" aria-hidden="true" style="font-size: 20px; margin-bottom: 20px; left: 6px; right: 0px;"></i></a><ul class="nav-second-level sidebar-nav sub-menu" hidden=""></ul></li>';
