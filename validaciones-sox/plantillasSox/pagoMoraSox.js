function soxMora() {
    ...
    // Llenar SOX inicial
    const sox = `FECHAPAGOXX${fechaPago}LLLVALORCONSIGSNRXX${pagoSNR}LLLVALORPAGOPRODUCTOXX0LLLVALORHONORARIOSXX${honorarios}LLLVALORPRODUCTOXX${pagoSNR}LLLTIPONEGXXTELLLLCUOTAPROYECTADAXXNO APLICALLLOBSERVACIONESXX${observacionesBase}LLLEXCEPCIONXX
