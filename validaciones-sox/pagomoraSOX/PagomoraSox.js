function soxMora() {
    ...
    let honorarios = getFieldValue("ae33bcc4-183a-47de-a6c8-f4ecc44be169") || 0;
    ...
    // Llenar SOX inicial
    const sox = `FECHAPAGOXX${fechaPago}LLLVALORCONSIGSNRXX${pagoSNR}LLLVALORPAGOPRODUCTOXX0LLLVALORHONORARIOSXX${honorarios}LLLVALORPRODUCTOXX${pagoSNR}LLLTIPONEGXX${tipoGestion}LLLCUOTAPROYECTADAXXNO APLICALLLOBSERVACIONESXX${observacionesBase}LLLEXCEPCIONXX
